...
import { AlertCircle, Database, FileText, Zap } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Documentation for submitting telemetry data from your ESP32-C3 smart
          glasses
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          All timestamps must be in nanoseconds (multiply milliseconds by
          1,000,000). Blink rates are also bigint values.
        </AlertDescription>
      </Alert>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <CardDescription>
              Submit data as it's collected from your sensors for immediate
              analysis
            </CardDescription>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Required fields for telemetry submission
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Unique identifier for your ESP32-C3 device (e.g.,
                  "glasses-001")
                </p>
              </div>
        ...
        <CardContent className="space-y-3">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                If your device collects data frequently, consider batching
                multiple measurements into fewer API calls to reduce overhead.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Implement retry logic for network failures. The backend will
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Keep your device ID consistent across all requests to ensure
                data is properly grouped for analysis.
              </p>
            </div>
          </div>
        </CardContent>
